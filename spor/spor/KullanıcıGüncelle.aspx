<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="KullanıcıGüncelle.aspx.cs" Inherits="spor.WebForm3" %>
    ...
    <form id="Form1" runat="server">
        <div class="form-group">
            ...
            <div>
            <asp:Label for="TxtKullanıcıId" runat="server" Text="KullanıcıId" style="font-weight: 700"></asp:Label>
            <asp:TextBox ID="TxtKullanıcıId" runat="server"></asp:TextBox>
        </div>
            <br />
            <div>
        ...
        <asp:Button runat="server" Text="Değişiklikleri Kaydet"  CssClass="btn btn-success" OnClick="Unnamed12_Click" />
